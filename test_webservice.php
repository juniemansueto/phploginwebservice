...
$jsonObj = file_get_contents($webservice_url.'/?tag=register&name=junie&email=junie@test.com&password=12345');
...
$jsonObj = file_get_contents($webservice_url.'/?tag=login&email=junie@test.com&password=12345');
$final_res =json_decode($jsonObj, true) ;
